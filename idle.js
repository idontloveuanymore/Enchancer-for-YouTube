...
function(a){window.wrappedJSObject.efyt_prefs=cloneInto(a,window);document.dispatchEvent(new Event("efyt-update-preferences"));XPCNativeWrapper(window.wrappedJSObject.efyt_prefs)})})();